...
#import "NSString+JulianDate.h"

@implementation NSString(JulianDate)

+(NSString *)getJulianTimeStamp
{
    __autoreleasing NSDate *date = [NSDate date];
    double timeIntervalSince1970 = [date timeIntervalSince1970];
    double timeStampInJulian = (timeIntervalSince1970/(double)86400)+(double)2440587.5;
    NSNumber *timeStamp =[NSNumber numberWithDouble:timeStampInJulian];
